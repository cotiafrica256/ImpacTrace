...
class PaymentController extends Controller {
 ...
 public function initiate(Request $r, AccessPackage $package){
  ...
  if($r->input('method')==='momo_manual') return response()->json(['payment'=>$p,'instructions'=>'Pay the displayed amount, then submit the last 5 characters of your transaction reference.']);
